...
type Matrix = 
   ...
   static member ( +  ) : matrix1:Matrix * matrix2:Matrix -> Matrix
   ...
   /// Point-wise addition of two matrices. An InvalidArgument exception will be
   /// raised if the dimensions do not match.
   static member ( +  ) : matrix1:Matrix * value:float -> Matrix

   /// Subtract each element of a matrix by the given scalar value
   static member ( -  ) : matrix:Matrix * value:float -> Matrix
   ...
   static member ( * ) : matrix:Matrix * vector:Vector -> Vector
   ...
   static member ( * ) : value:float          * matrix:Matrix -> Matrix
   ...
   member NonZeroEntries: seq<int * int * float> 
...
and 
 ...
 Vector = 
   ...
   member Item : index:int -> float with get,set
   ...
   static member ( +  ) : vector1:Vector    * vector2:Vector -> Vector
   ...
   static member ( * ) : value:float             * vector:Vector -> Vector

   /// Multiply a vector by a scalar
   static member ( * )   : vector:Vector    * value:float          -> Vector
